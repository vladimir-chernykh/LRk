...
//***********************************************************************
TiXmlStyle::TiXmlStyle( const char *  _type,
				        const char *  _href )
	: TiXmlNode( TiXmlNode::STYLE )
{
	type = _type;
	href = _href;
}
...
#ifdef TIXML_USE_STL
TiXmlStyle::TiXmlStyle(	const std::string& _type,
...
TiXmlStyle::TiXmlStyle( const TiXmlStyle& copy )
	: TiXmlNode( TiXmlNode::STYLE )
{
	copy.CopyTo( this );	
}
...
void TiXmlStyle::operator=( const TiXmlStyle& copy )
{
	Clear();
	copy.CopyTo( this );
}
...
void TiXmlStyle::Print( FILE* cfile, int /*depth*/ ) const
{
...
void TiXmlStyle::StreamOut( TIXML_OSTREAM * stream ) const
{
...
void TiXmlStyle::CopyTo( TiXmlStyle* target ) const
{
	TiXmlNode::CopyTo( target );
...
TiXmlNode* TiXmlStyle::Clone() const
{	
	TiXmlStyle* clone = new TiXmlStyle();
