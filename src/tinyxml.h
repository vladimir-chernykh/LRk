...
public:
	...
	*/
	...
	/** Query the type (as an enumerated value, above) of this node.
		The possible types are: DOCUMENT, ELEMENT, COMMENT,
								UNKNOWN, TEXT, STYLE and DECLARATION.
	*/
	...
	*/
	...
	virtual const TiXmlStyle*       ToStyle()       const { return 0; } ///< Cast to a more defined type. Will return null if not of the requested type.
	...
	virtual TiXmlStyle*             ToStyle()       { return 0; } ///< Cast to a more defined type. Will return null if not of the requested type.
...
/** In correct XML the style can be declared in the second entry of the file.
	@verbatim
		<?xml-stylesheet href="[path to style]" type="[style def]"?>
	@endverbatim

	TinyXml will happily read or write files without a style declaration,
	however. There are 2 required attributes to the declaration:
	href and type.
    There are 4 optional required attributes to the declaration:
	...
	Note: In this version of the code, the attributes are
	handled as special cases, not generic attributes, simply
	because only the two required attributes are processed.
*/
class TiXmlStyle : public TiXmlNode
{
public:
	/// Construct an empty declaration.
	TiXmlStyle()   : TiXmlNode( TiXmlNode::STYLE ) {}

#ifdef TIXML_USE_STL
	/// Constructor.
	TiXmlStyle(	const std::string& _type,
				const std::string& _href );
#endif

	/// Construct.
	TiXmlStyle(	const char* _type,
				const char* _href );

	TiXmlStyle( const TiXmlStyle& copy );
	void operator=( const TiXmlStyle& copy );
	...
	virtual const TiXmlStyle* ToStyle() const { return this; } ///< Cast to a more defined type. Will return null not of the requested type.
	virtual TiXmlStyle*       ToStyle()       { return this; } ///< Cast to a more defined type. Will return null not of the requested type.

protected:
	void CopyTo( TiXmlStyle* target ) const;
	// used to be public
	#ifdef TIXML_USE_STL
	    virtual void StreamIn( TIXML_ISTREAM * in, TIXML_STRING * tag );
	#endif
